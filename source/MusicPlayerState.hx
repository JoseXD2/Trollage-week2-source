...
class MusicPlayerState extends MusicBeatState
{
    ...
    override function create()
    {
        ...
        var initSonglist = ['internal,trolling,trolling,good', 'internal,mistaken,trolling2,good', 'internal,the-incident,trolling3,good', 'internal,tomfoolery,magneto,good', 'internal,turn-the-trolls-off,ttto,good', 'internal,absurde,trolling,good', 'internal,happiness,happy,good', 'internal,smile,happy,good', 'internal,imposter,no-bobux,good', 'internal,alone-forever,alone,good', 'internal,ultimate-trolldown,troil,good', 'internal,trollistic,whitty,good']; //ah yeah dj song list
        ...
        healthBarBG = new FlxSprite(0, FlxG.height * 0.9).loadGraphic(Paths.image('Blueballs/healthBar', 'Troll'));
        ...
        healthBar.createFilledBar(0xFFFFFFFF, 0xFF00FFFF);
		add(healthBar);
		...
		iconP2 = new HealthIcon("trolling", false);
