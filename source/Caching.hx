...
class Caching extends MusicBeatState
{
	...
	override function create()
	{
		...
		for (i in FileSystem.readDirectory(FileSystem.absolutePath("assets/Troll/images/Characters")))
		{
			if (!i.endsWith(".png"))
				continue;
			images.push(i);
	...
	function cache()
	{
		...
		for (i in images)
		{
			...
			var data:BitmapData = BitmapData.fromFile("assets/Troll/images/Characters/" + i);
